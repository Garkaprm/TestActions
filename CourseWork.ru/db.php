...
<html>
   ...
   ?>
    ...
    <body style="margin: 0; overflow-y: scroll; background: #c5c5c5;" >
            ...
            <content>
                <br><br><br>
                <p style="text-align: center; font-size: large">Выберите базу данных:</p>
                <?php
                $i = 0;
                $j = 0;
                $result = mysqli_query($connection, 'SHOW DATABASES');
                ...
                while ($j<$i)
                {
                    ...
                    <tr>
                        <td>
                            <form method="post">
                                <input name="db" type="submit" class="db" value="<? print join('', $_SESSION[$j]);?>" formaction="table_db.php">
                            </form>
                        </td>
                    </tr>
                    <?
