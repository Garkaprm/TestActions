...
<html>
   ...
   ?>
    ...
    <body style="margin: 0; overflow-y: scroll; background: #c5c5c5;" >
            ...
            <content>
                <br>
                <p style="text-align: center"><b>Топ 10 сайтов по количеству посещений за все время:</b></p><hr><br>
                <?php
                        $sql = "select adress as 'Сайт', CountVisit as 'Количество посещений' from sites order by CountVisit DESC LIMIT 10";
