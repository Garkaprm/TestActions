...
<html>
   ...
   ?>
    ...
    <body style="margin: 0; overflow-y: scroll; background: #c5c5c5;" >
            ...
            <content>
                <br><br><br><br>
                <p style="text-align: center; font-size: large" >Введите название новой базы данных</p>
                <form action="create_db.php" method= "POST">
                    <input name="Text" type="text" style="height: 30px; width: 100%;" size="100" placeholder="Новая база данных">
                ...
                {
                    $sql = ($_POST['Text']);
                    mysqli_query($connection, "CREATE DATABASE $sql");
                    print '<p style="font-size: large; text-align: center">База данных добавлена</p>';
                }?>
            </content>
    </body>
</html>