...
<html>
   ...
   ?>
    ...
    <body style="margin: 0; overflow-y: scroll; background: #c5c5c5;" >
            ...
            <content>
                <br><br>
                <p style="text-align: center"> Введите новую причину посещения компьютерного класса, которая будет доступна для выбора при регистрации<br>
                <br><br>
                <form action="AddReason.php" method= "POST">
                    <input name="Text" type="text" style="height: 30px; width: 80%;" size="100" placeholder="Причина посещения">
                    <input type="submit" class="submit" style="padding: 10px 20px; float: right" value= "Добавить"><br><br>
                </form>
                <p style="text-align: center"><b>Результат:</b></p><hr><br>
                <?php
                    if (isset($_POST['Text']) & !empty($_POST['Text']))
                    {
                        $NewReason = ($_POST['Text']);
						$sql = "insert into ReasonWork (reason) values ('$NewReason')";
