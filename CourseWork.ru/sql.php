...
<html>
   ...
   ?>
    ...
    <body style="margin: 0; overflow-y: scroll; background: #c5c5c5;" >
            ...
            <content>
                <br><br>
                <p style="text-align: center"> Введите Ваш запрос<br>
                <br><br>
                <form action="sql.php" method= "POST">
                    <input name="Text" type="text" style="height: 30px; width: 100%;" size="100" placeholder="SQL запрос">
                    <input type="submit" class="submit" style="padding: 10px 20px; float: right" value= "Выполнить"><br><br>
                </form>
                <p style="text-align: center"><b>Результат запроса:</b></p><hr><br>
                <?php
