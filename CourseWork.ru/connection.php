...
<html>
   ...
   ?>
    ...
    <body style="margin: 0; overflow-y: scroll; background: #c5c5c5;" >
            ...
            <content>
                <br><br><br>
                <p style="text-align: center; font-size: large"> Вы подключены к серверу:<br>
                    <? print mysqli_get_host_info($connection).'<br>'; ?>
                </p>
                <p style="text-align: center; font-size: large"> Информация о клиенте:<br>
                    <? print mysqli_get_client_info($connection).'<br>'; ?>
                </p>
                <p style="text-align: center; font-size: large"> Версия сервера:<br>
                    <? print mysqli_get_server_info($connection).'<br>'; ?>
                </p>
                <p style="text-align: center; font-size: large"> Кодировка сервера:<br>
                    <? print mysqli_character_set_name($connection)?>
                </p>
            </content>
    </body>
</html>