...
<html>
    <?php
		...
		if ($_POST['db'] == "coursework")
			{
				$new_url = "New_table_db.php";
   ...
   ?>
    ...
    <body style="margin: 0; overflow-y: scroll; background: #c5c5c5;" >
            ...
            <content>
                <br><br><br>
                <p style="text-align: center; font-size: large">В базе данных содержатся следующие таблицы:</p>
                <?php
                if (isset($_POST))
                {
                    ...
                    <hr>
                    <form method="post">
                        <input name="db" type="submit" class="del" value="Удалить базу данных" formaction="del_db.php">
                    </form>
                    <?
                }?>
            </content>
